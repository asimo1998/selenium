...
public class PageDashBoardLocator {
    ...
    public static final XpathLocator buttonCancelOnPopup = XpathLocator.create("//div[@class='modal-footer']//child::button[normalize-space()='Cancel'");
    ...
    public static final XpathLocator inputUserNameOnPopup = XpathLocator.create("//input[@id='UserName']"); // đặt tên cụ thể VD: inputUsernameOnCreateNewUserPopup
    ...
    public static final XpathLocator formVerifyAccountPopupNotDisplay = XpathLocator.create("//div[@aria-labelledby=\"createOrEditModal\"]//child::form[count(div)=3]"); // xóa những đoạn code không dùng tới
    ...
    public static final XpathLocator buttonActions = XpathLocator.create("//button[@id=\"dropdownButton\" and normalize-space(text())=\"Actions\"]");
    ...
    5. class
    6. text
    3. tagname đặt biệt VD: thẻ head, button, table, tr, td, th, tbody,
    */
